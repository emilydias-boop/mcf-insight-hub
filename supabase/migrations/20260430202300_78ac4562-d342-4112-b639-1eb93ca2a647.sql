...
BEGIN
  ...
  -- CORREÇÃO: deduplica por (deal_id, meeting_day) para não inflar
  -- com duplicatas/reagendamentos do mesmo lead no mesmo dia.
  -- Mantém cap de 2 por lead (igual R1 Agendada).
  -- ============================================================
