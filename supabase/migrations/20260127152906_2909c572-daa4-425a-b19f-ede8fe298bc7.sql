-- Atualizar get_all_hubla_transactions para excluir transações temporárias newsale-
...
BEGIN
  ...
  WHERE 
    ...
    AND ht.hubla_id NOT LIKE 'newsale-%'  -- Excluir transações temporárias
...
-- Atualizar get_hubla_transactions_by_bu para excluir transações temporárias newsale-
