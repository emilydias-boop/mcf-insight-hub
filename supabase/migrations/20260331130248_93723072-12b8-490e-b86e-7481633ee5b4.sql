-- Drop and recreate both overloaded versions with booked_at field
...
BEGIN
  ...
  SELECT
    ...
    msa.booked_at::text                                 AS booked_at
...
-- 4-param version
DROP FUNCTION IF EXISTS public.get_sdr_meetings_from_agenda(text, text, text, text);
