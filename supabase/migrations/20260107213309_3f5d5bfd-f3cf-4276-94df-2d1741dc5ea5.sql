-- Atualizar get_sdr_metrics_v2 para incluir "Sem Interesse" como origem válida
...
-- Atualizar get_sdr_all_movements_v2 para incluir "Sem Interesse" como origem válida
