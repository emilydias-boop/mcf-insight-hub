...
AS $function$
  ...
  WHERE s.role_type = 'sdr'
    ...
    -- Excluir apenas usuários com função PURAMENTE administrativa.
    -- SDRs com função adicional de closer/closer_sombra (dupla função operacional)
    -- continuam aparecendo nas métricas de SDR.
    AND NOT EXISTS (
