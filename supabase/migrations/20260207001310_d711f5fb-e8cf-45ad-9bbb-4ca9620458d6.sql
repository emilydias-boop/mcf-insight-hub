-- Atualizar RPCs para incluir reference_price da tabela product_configurations
-- Isso corrige o cálculo de faturamento bruto que estava usando product_price (valor pago) ao invés do preço de tabela
...
-- Recriar get_hubla_transactions_by_bu com reference_price
...
-- Recriar get_all_hubla_transactions com reference_price
