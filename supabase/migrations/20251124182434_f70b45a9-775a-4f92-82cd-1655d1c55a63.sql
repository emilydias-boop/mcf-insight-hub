-- Corrigir função upsert_deals_smart para tratar tags corretamente
-- Problema: tags pode ser null, string vazia, ou não ser um array
-- Solução: Verificar tipo antes de extrair elementos
...
BEGIN
  ...
  LOOP
    ...
    VALUES (
      ...
      (deal->>'origin_id')::uuid,
      (deal->>'owner_id')::text,
      -- 🔧 FIX: Verificar se tags é um array antes de extrair elementos
      CASE 
