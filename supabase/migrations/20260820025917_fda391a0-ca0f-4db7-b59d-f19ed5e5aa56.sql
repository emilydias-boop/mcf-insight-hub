...
WITH base AS (
  SELECT
    ...
    -- BU do fato = a agenda ONDE A REUNIAO OCORREU, ou seja a BU do closer do slot.
    -- O cadastro de origem do lead (bu_origin_mapping) NAO decide mais isso: era
    -- dado periferico derrubando fato de agenda.
    cl.bu AS fato_bu
