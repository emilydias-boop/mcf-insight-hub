-- Sincronizar contagem de contratos SDR com Closers
-- Usar contract_paid_at (data do pagamento) em vez de scheduled_at (data da reunião)
-- Incluir status 'refunded' no total de contratos
