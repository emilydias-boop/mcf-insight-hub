...
-- Reprocessa transações Hubla de A005-A008 para recriar títulos removidos
UPDATE public.hubla_transactions
SET updated_at = now()
WHERE sale_status IN ('completed','paid')
  AND public.ar_extract_product_code(product_name) IN ('A005','A006','A007','A008');
