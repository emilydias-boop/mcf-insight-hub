-- Reverte a função para mostrar TODAS as transações (incluindo parents)
-- Remove a lógica de exclusão de parents que estava causando erro de ambiguidade
...
BEGIN
  ...
  -- Apenas exclui newsale-% (transações duplicadas)
  all_transactions AS (
    SELECT 
      ht.id,
      ht.hubla_id,
