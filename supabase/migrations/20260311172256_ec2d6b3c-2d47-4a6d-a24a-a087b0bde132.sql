...
-- Recriar get_all_hubla_transactions com deduplicação por prioridade de fonte
...
-- Recriar get_hubla_transactions_by_bu com deduplicação por prioridade de fonte
