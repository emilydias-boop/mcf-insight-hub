-- Primeiro, dropar as funções existentes com os parâmetros timestamp
...
-- Recriar get_all_hubla_transactions (versão com timestamp with time zone)
...
-- Recriar get_hubla_transactions_by_bu (versão com timestamp with time zone)
