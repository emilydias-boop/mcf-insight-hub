...
DECLARE 
  ...
  v_consorcio_stage_ids uuid[] := ARRAY[
    'aa194279-c40e-458d-80aa-c5179b414658'::uuid,
    'a35fea26-805e-40d5-b604-56fd6319addf'::uuid,
    '2357df56-bfad-4c4c-b37b-c5f41ce08af6'::uuid,
    'cee41f5d-aad9-435d-a6ee-a96bbda6f257'::uuid
  ];
BEGIN
  ...
  -- No-shows: cap de 2 por lead em qualquer data (3o+ no-show ignorado)
  noshow_per_lead AS (
