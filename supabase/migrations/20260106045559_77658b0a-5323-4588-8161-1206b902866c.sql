-- Atualizar get_sdr_metrics_v2 com deduplicação por deal+dia
...
BEGIN
  ...
  -- Apenas primeira movimentação por deal+dia
  deduplicated AS (
...
-- Atualizar get_sdr_all_movements_v2 com deduplicação
...
BEGIN
  ...
  SELECT 
    ...
    (rm.rn_dia = 1)::BOOLEAN as conta_mov,  -- Só conta se for primeira do dia
