...
BEGIN
  ...
  per_day AS (
    SELECT DISTINCT ON (b.b_booker_email, b.b_deal_id, b.b_meeting_day)
      b.*,
      MIN(b.b_effective_booked_at) OVER (PARTITION BY b.b_booker_email, b.b_deal_id, b.b_meeting_day) as b_first_booked_at_day
    FROM base b
    ORDER BY b.b_booker_email, b.b_deal_id, b.b_meeting_day, b.b_effective_booked_at, b.b_scheduled_at
  ),
  ranked AS (
    SELECT pd.*,
      ROW_NUMBER() OVER (
        PARTITION BY pd.b_booker_email, pd.b_deal_id
