-- Drop existing functions with incorrect column names
...
-- Recreate get_all_hubla_transactions with correct column names
...
-- Recreate get_hubla_transactions_by_bu with correct column names
