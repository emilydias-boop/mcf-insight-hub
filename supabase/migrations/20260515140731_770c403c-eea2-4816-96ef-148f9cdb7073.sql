-- RPC to list users a SDR/Closer can transfer leads to (same squad/BU).
-- Admin/Manager/Coordenador see everyone.
...
GRANT EXECUTE ON FUNCTION public.list_transferable_users() TO authenticated;