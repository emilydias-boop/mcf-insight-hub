...
- [ ] Ajustar `public.relatorio_diario_bu(date)`: remover linhas `bu='solar'` (15 linhas), ticket consórcio = efetivado/clientes, e nova coluna `agregacao` ('aditivo' | 'nao_somavel').
