...
export const CONSORCIO_SDR_TARGET_CONFIGS: SdrTargetConfig[] = [
  ...
  { type: 'consorcio_sdr_cota_contratada_dia' as SdrTargetType, label: 'Cotas Contratadas', period: 'day' },
  ...
  { type: 'consorcio_sdr_cota_contratada_semana' as SdrTargetType, label: 'Cotas Contratadas', period: 'week' },
  ...
  { type: 'consorcio_sdr_cota_contratada_mes' as SdrTargetType, label: 'Cotas Contratadas', period: 'month' },
