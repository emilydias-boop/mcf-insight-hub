...
import ConfigurarLinksReuniao from "./pages/crm/ConfigurarLinksReuniao";
        ...
        <BrowserRouter>
          <AuthProvider>
            ...
            >
              ...
              <Route path="crm/configurar-links-reuniao" element={<ResourceGuard resource="configuracoes"><ConfigurarLinksReuniao /></ResourceGuard>} />
