    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Gerencie equipe, SDRs, planos de compensação e métricas</p>
        </div>
      </div>
            ...
            <CardContent>
              {employeesLoading ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm mt-2">Acesse o módulo de RH para cadastrar colaboradores na BU Consórcio.</p>
                </div>
              ) : (
                <Table>
                  <TableHeader>
              ...
              <div className="mt-4 text-xs text-muted-foreground bg-muted/50 rounded-md p-3 border">
                <strong>Fonte de dados:</strong> Os colaboradores são gerenciados no módulo de RH. Para aparecer nesta
                lista, o colaborador deve estar na BU Consórcio. Para SDRs do fechamento, use a aba "SDRs" para
