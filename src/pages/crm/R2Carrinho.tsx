...
export default function R2Carrinho() {
  ...
  const kpiCards: Array<{
    ...
    null,
    {
      ...
      title: 'Pendentes desta safra cujo contrato foi pago em semanas anteriores aparecem como ↩.',
    },
    {
      label: 'No-Show R2',
          ...
          {(() => {
            ...
            return (
              <div className="text-xs text-muted-foreground mt-0.5 space-y-0.5">
                <p>Janela do Carrinho (R2s): {format(b.carrinhoOperacional.start, "dd/MM HH:mm", { locale: ptBR })} → {format(b.carrinhoOperacional.end, "dd/MM HH:mm", { locale: ptBR })} (corte anterior → corte atual)</p>
