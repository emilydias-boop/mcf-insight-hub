          ...
          {(() => {
            ...
            return (
              <div className="text-xs text-muted-foreground mt-0.5 space-y-0.5">
                <p>Janela do Carrinho (R2s): {format(b.carrinhoOperacional.start, "dd/MM HH:mm", { locale: ptBR })} → {format(b.carrinhoOperacional.end, "dd/MM HH:mm", { locale: ptBR })} (Sáb → Sex do corte)</p>
