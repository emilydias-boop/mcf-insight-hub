...
export function PlaybookReadStats({ open, onOpenChange, doc, embedded = false }: PlaybookReadStatsProps) {
  ...
  const { data: usersData } = useQuery({
    ...
    enabled: !!doc?.role && (open || embedded),
  });
  ...
  // Se embedded, renderiza só o conteúdo sem Dialog
  if (embedded) {
    return statsContent;
  }
