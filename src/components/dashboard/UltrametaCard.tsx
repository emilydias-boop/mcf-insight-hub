...
export function UltrametaCard({ data }: UltrametaCardProps) {
  return (
    <Card className="bg-gradient-to-b from-success/5 to-success/10 border-success/20">
      <CardContent className="p-6">
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 pb-2 border-b border-border">
            ...
            <div>
              <p className="text-sm font-medium text-muted-foreground uppercase tracking-wide">Ultrameta Clint</p>
              <p className="text-2xl font-bold text-success">{formatCurrency(data.ultrametaClint)}</p>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-2">
            <div className="space-y-1 pt-3 border-t border-border/50">
              <p className="text-xs font-medium text-muted-foreground uppercase tracking-wide">Faturamento Incorporador 50k</p>
