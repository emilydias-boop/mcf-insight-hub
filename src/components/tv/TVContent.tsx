...
export function TVContent({
    ...
    return (
      <div className="flex flex-col h-full gap-3 overflow-y-auto">
        ...
        <div className="shrink-0">
          <h3 className="font-bold text-center text-xs mb-1">Pipeline</h3>
  ...
  return (
    <div className="flex flex-col h-full gap-3">
      ...
      <div className="grid grid-cols-[200px_180px_1fr] gap-4 flex-1 min-h-0">
        ...
        <div className="flex flex-col gap-2 h-full">
          <h3 className="font-bold text-center text-base">Pipeline</h3>
          <PipelineColumn funnelData={funnelDataA} leadType="A" />
        </div>
