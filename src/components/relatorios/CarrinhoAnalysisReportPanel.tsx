...
export function CarrinhoAnalysisReportPanel({ bu }: CarrinhoAnalysisReportPanelProps) {
  ...
  const exportExcel = () => {
    ...
    const ws = XLSX.utils.json_to_sheet(filteredLeads.map(l => ({
      ...
      'Valor Parceria': l.parceriaBruto != null ? l.parceriaBruto : '',
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Vlr. Parceria</TableHead>
                    ...
                    {filteredLeads.slice(0, 300).map((l, i) => (
                      <TableRow key={i} className={cn(l.reembolso && 'opacity-60')}>
                        ...
                        <TableCell className="text-xs whitespace-nowrap">
                          {l.parceriaBruto != null ? `R$ ${l.parceriaBruto.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}` : '—'}
                        </TableCell>
                        <TableCell>
