...
export function TeamKPICards({
  ...
  const cards: Array<{
    ...
    }]),
    {
      ...
      tooltip: "Toda reunião marcada PARA o período, contada linha por linha como aparece na Agenda R1 — inclusive as agendadas por closer/coordenador. Se o mesmo lead tem duas marcações, as duas contam. Bate com a linha Total da aba Closers; as abas mostram a atribuição por pessoa.",
    ...
    },
    {
      ...
      tooltip: "Reuniões em que o lead compareceu, contadas linha por linha na Agenda R1 (compareceu, contrato pago ou reembolsado). Independe de quem agendou e bate com a linha Total da aba Closers.",
    ...
    },
    {
      ...
      tooltip: "Toda falta registrada na agenda no período, inclusive de lead que compareceu depois: se faltou, aconteceu, conta. Contado linha por linha na Agenda R1, independente de quem agendou, e bate com a linha Total da aba Closers.",
